# Generated by Powerlevel10k configuration wizard on 2020-07-28 at 09:41 JST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 3380.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 12h time, angled separators, round heads, flat tails, 2 lines, disconnected,
# left frame, dark-ornaments, sparse, many icons, fluent, instant_prompt=off.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='sizumita'
